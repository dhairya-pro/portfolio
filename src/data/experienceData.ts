...
export const EXPERIENCES: ExperienceItem[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Deployed platform live, currently serving 300+ monthly visitors with zero downtime.",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Built high-throughput Node.js/MongoDB APIs with compound query indexing.",
